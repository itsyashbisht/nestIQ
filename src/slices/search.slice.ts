...
const searchSlice = createSlice({
  ...
  reducers: {
    ...
    setResults(
      state,
      action: PayloadAction<{ results: IHotel[]; total: number; aiInsight?: string }>
    ) {
...
export const { setQuery, setFilters, resetFilters, setResults, setSearchLoading, setSearchError } =
  searchSlice.actions;
