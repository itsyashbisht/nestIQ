...
const upsertBookingInList = (list: IBooking[], booking: IBooking): IBooking[] => {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createBooking.fulfilled, (state, action) => {
        ...
        state.myBookings = upsertBookingInList(state.myBookings, action.payload.booking);
      })
      ...
      .addCase(updateBookingStatus.fulfilled, (state, action) => {
        ...
        state.myBookings = upsertBookingInList(state.myBookings, action.payload);
        state.allBookings = upsertBookingInList(state.allBookings, action.payload);
      })
